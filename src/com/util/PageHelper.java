...
public class PageHelper {
	...
	public static void getPage(List<?> list, String name, List<String> nameList, List<String> valueList, int pageSize, String number,
		...
		if ((Integer.parseInt(number) + 1) == 1) {
			...
			buffer.append("<a href=\"" + name + "/" + action + "?number=0" + path + "\" style=\"color: #c5d52b;\">首页</a>");
		}
		buffer.append("&nbsp;&nbsp;");
		if ((Integer.parseInt(number) + 1) == 1) {
			buffer.append("上一页");
		} else {
			buffer.append("<a href=\"" + name + "/" + action + "?number=" + (Integer.parseInt(number) - 1) + "" + path + "\" style=\"color: #c5d52b;\">上一页</a>");
		}
		buffer.append("&nbsp;&nbsp;");
